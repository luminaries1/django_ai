...
class_label = ['airplane', 'angel', 'ant', 'apple', 'arm', 'axe', 'backpack', 'banana', 'bandage', 'baseball bat', 'bat', 'bathtub', 'beach', 'bear', 'beard', 'bed', 'bee', 'belt', 'bicycle', 'bird', 'blueberry', 'book', 'boomerang', 'bracelet', 'brain', 'bread', 'broccoli', 'broom', 'bucket', 'bus', 'bush', 'butterfly', 'cactus', 'cake', 'calculator', 'calendar', 'camel', 'camera', 'candle', 'cannon', 'canoe', 'car', 'carrot', 'castle', 'cat', 'cell phone', 'cello', 'chair', 'church', 'circle', 'clock', 'cloud', 'compass', 'computer', 'cookie', 'couch', 'cow', 'crab', 'crayon', 'crocodile', 'crown', 'cup', 'diamond', 'dishwasher', 'dog', 'dolphin', 'donut', 'door', 'dragon', 'drill', 'duck', 'ear', 'elbow', 'elephant', 'envelope', 'eraser', 'eyeglasses', 'face', 'feather', 'fence', 'finger', 'firetruck', 'fish', 'floor lamp', 'flower', 'foot', 'fork', 'frog', 'giraffe', 'grapes', 'grass', 'guitar', 'hamburger', 'hammer', 'hand', 'harp', 'hat', 'headphones', 'helicopter', 'horse', 'hospital', 'hot dog', 'house', 'ice cream', 'jacket', 'jail', 'kangaroo', 'key', 'keyboard', 'knee', 'ladder', 'laptop', 'leaf', 'leg', 'light bulb', 'lightning', 'lion', 'lipstick', 'map', 'matches', 'microphone', 'monkey', 'moon', 'mosquito', 'mountain', 'mouse', 'mouth', 'mushroom', 'nail', 'necklace', 'nose', 'ocean', 'octagon', 'octopus', 'onion', 'oven', 'owl', 'paintbrush', 'panda', 'pants', 'paper clip', 'parachute', 'passport', 'peanut', 'pencil', 'penguin', 'piano', 'picture frame', 'pig', 'pillow', 'pineapple', 'pizza', 'pond', 'potato', 'purse', 'rabbit', 'raccoon', 'radio', 'rain', 'rainbow', 'remote control', 'rhinoceros', 'river', 'roller coaster', 'sandwich', 'saw', 'scissors', 'scorpion', 'screwdriver', 'shark', 'sheep', 'shoe', 'sink', 'skull', 'skyscraper', 'snail', 'snake', 'snowflake', 'snowman', 'soccer ball', 'sock', 'spider', 'spoon', 'stairs', 'star', 'steak', 'strawberry', 'streetlight', 'submarine', 'sun', 'swan', 'sword', 't-shirt', 'table', 'tiger', 'tooth', 'toothbrush', 'toothpaste', 'tornado', 'traffic light', 'train', 'tree', 'triangle', 'umbrella', 'watermelon', 'whale', 'wheel', 'windmill', 'wine glass', 'zebra']
